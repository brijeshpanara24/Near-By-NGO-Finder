...
public class EditEvent {
    ...
    public void editEvent() {
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.etDescription), withText("Donate you cloth to poor people who really need them"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.support.design.widget.TextInputLayout")),
                                        0),
                                0)));
        appCompatEditText4.perform(scrollTo(), replaceText("Donate you cloth to poor people who really need them"));
