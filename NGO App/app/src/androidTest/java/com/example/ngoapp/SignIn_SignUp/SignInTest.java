        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.etEmail),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("navjeevan@gmail.com"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.etEmail),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("navjeevantrust@gmail.com"), closeSoftKeyboard());
